...
import cgi, string, sys, os, re, random, subprocess
...
def run_app(form):
    ...
    cmd = ['java','-jar','cetus.jar',file_name]
...
def print_more():
    ...
    print"""
            <!-- end .content --></div>
            <div class="footer"><p align="right">LCF 2011-2013</p>
            <!-- end .footer --></div>
            <!-- end .container --></div>
            </body>
            </html>
